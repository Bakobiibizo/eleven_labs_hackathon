...
"""Source:https://github.com/hwchase17/langchain/blob/master/langchain/load/serializable.py """
...
class Serializable(BaseModel, ABC):
    ...
    def to_json(self) -> Union[SerializedConstructor, SerializedNotImplemented]:
        ...
        return {
            ...
            "kwargs": _replace_secrets(lc_kwargs, secrets)
            if secrets else lc_kwargs,
        }
