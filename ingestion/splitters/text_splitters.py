...
from document.documents import BaseDocumentTransformer
...
class NLTKTextSplitter(TextSplitter):
    """A class that splits text into sentences using the NLTK library.
    ...
    def __init__(self, separator: str = "\n\n", **kwargs: Any) -> None:
        """Initialize the NLTKTextSplitter instance.
...
class SpacyTextSplitter(TextSplitter):
    """A class that splits text into sentences using Spacy.
    ...
    def __init__(
        ...
        """Initialize the SpacyTextSplitter instance.
...
class PythonCodeTextSplitter(RecursiveCharacterTextSplitter):
    """A class that attempts to split text along Python syntax.
...
class MarkdownTextSplitter(RecursiveCharacterTextSplitter):
    """A class that attempts to split text along Markdown-formatted headings.
...
class LatexTextSplitter(RecursiveCharacterTextSplitter):
    """A class that attempts to split text along LaTeX-formatted layout elements.
